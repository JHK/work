...
*Enforced by:* `TestNoSystemReachesAnother` in `internal/work/imports_test.go`, which reads every implementation's imports with `UseAllFiles`, test compilations included.
