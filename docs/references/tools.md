...
| the [editor](configuration.md#keys), `$VISUAL` else `$EDITOR` by default | `--editor` | unset, the invocation is refused before anything is created or claimed | `internal/config/command.go` |
