...
Ask for a name of your own and you get a branch of your own, with [nothing to vet and nothing to claim](../references/integrations.md#beads). Not everything worth a checkout is worth a ticket, and a tool that only opened the worktrees a tracker had blessed would be that tracker's front end rather than a switcher.
